	...
	<nav class="site-nav">
		<div class="container">
			<div class="site-navigation">
				<a href="index.html" class="logo m-0 float-left">Assemblies of God</a>
			...
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-5 me-auto text-start pe-lg-5">
					<div class="intro-text">
						<div class="mb-4">
							<h1 data-aos="fade-left" class="hero-heading">WHo We Are</h1>
						</div>
						<div class="">
							<p class="mb-5 opacity-5" data-aos="fade-left" data-aos-delay="200">Assemblies of God Qatar
								is a Christ-centered community dedicated to spreading the Gospel and building a loving,
								faith-filled family of believers. As part of the global Assemblies of God fellowship, we
								strive to live out our faith through worship, discipleship, fellowship, and service.

								Our church is a place where people from all walks of life and diverse backgrounds come
								together to worship God, grow spiritually, and experience His transforming love. We are
								committed to helping individuals deepen their relationship with Christ and equipping
								them to serve both the church and the wider community.</p>
							<div style="display: flex; gap: 10px;">
								<p data-aos="fade-left" data-aos-delay="300"><a href="#" class="btn btn-primary">Go to
										sermons</a></p>
								<p data-aos="fade-left" data-aos-delay="300"><a href="#" class="btn btn-primary">Book
										Appointment</a></p>
							</div>
						</div>
					</div>
			...
			<div class="row g-5">
				<div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
					<div class="sermon-entry">
						<a href="sermon-single.html"><img src="images/rect-img-1.jpg" alt="Image"
				...
				<div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
					<div class="sermon-entry">
						<a href="sermon-single.html"><img src="images/rect-img-2.jpg" alt="Image"
								class="img-fluid mb-3 rounded"></a>
						<div class="sermon-body">
							<span class="date">15 Jan 2020 <span class="mx-2">&bullet;</span> By Pastor Campbell </span>
				...
				<div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
					<div class="sermon-entry">
						<a href="sermon-single.html"><img src="images/rect-img-3.jpg" alt="Image"
								class="img-fluid mb-3 rounded"></a>
						<div class="sermon-body">
							<span class="date">15 Jan 2020 <span class="mx-2">&bullet;</span> By Pastor Campbell </span>
		...
		<div class="container">
			<div class="row justify-content-between">
				<div class="col-lg-4" data-aos="fade-up">
					...
					<p>
						Assemblies of God Qatar is a vibrant, Christ-centered community committed to sharing the Gospel,
						fostering spiritual growth, and building meaningful relationships. We welcome people from all
						backgrounds to worship, grow in faith, and serve together in unity and love.</p>
				...
				<div class="col-lg-5 ms-auto" data-aos="fade-up" data-aos-delay="100">
					<div class="row g-4">
						<div class="col-lg-6 feature-1">
							...
							<p class="opac-white-5">
								We believe in living by faith, trusting in God's promises,
								and walking in obedience to His Word. Our journey is guided by hope, strengthened by
								prayer, and rooted in unwavering confidence in Jesus Christ. Through faith, we
								experience His love, grace, and transformative power in our lives. </p>
						</div>
						<div class="col-lg-6 feature-1">
							<h3 class="text-white">Love one another</h3>
							<p class="opac-white-5">
								We are called to reflect Christ’s love by caring for one
								another with compassion, kindness, and humility. By living out this command, we create a
								community where everyone feels valued, supported, and encouraged to grow in their faith.
							</p>
						</div>

						<div class="col-lg-6 feature-1">
							<h3 class="text-white">Be courageous</h3>
							<p class="opac-white-5">We are called to stand firm in our faith, face challenges with
								boldness, and trust in God’s strength to overcome. With courage, we step out in
								obedience to His purpose, knowing He is always with us, guiding and empowering us. </p>
						</div>
						<div class="col-lg-6 feature-1">
							<h3 class="text-white">Seal of God</h3>
							<p class="opac-white-5">We believe the seal of God is a mark of His ownership, protection,
								and promise over our lives. It signifies our identity as His children, chosen and
								redeemed, and reminds us of the eternal hope we have in Him. </p>
						</div>
