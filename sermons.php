...
<head>
	...
	<title>Aseemblies of God Qatar &mdash; Free Bootstrap 5 Website Template by Untree.co</title>
</head>
<body >
	...
	<div class="section">
		<div class="container">
			...
			<div class="row g-5">
				...
				<div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
					<div class="sermon-entry">
						<a href="sermon-single.html"><img src="images/sq-4.jpg" alt="Image" class="img-fluid mb-3 rounded"></a>
						<div class="sermon-body">
							<span class="date">10 Dec 2020 <span class="mx-2">&bullet;</span> By James Smith </span>
							<h3 class="mb-2"><a href="#">Live by faith not by Sight</a></h3>
							<p class="mb-5">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
				...
				<div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
					<div class="sermon-entry">
						<a href="sermon-single.html"><img src="images/sq-5.jpg" alt="Image" class="img-fluid mb-3 rounded"></a>
						<div class="sermon-body">
							<span class="date">10 Dec 2020 <span class="mx-2">&bullet;</span> By James Smith </span>
							<h3 class="mb-2"><a href="#">Live by faith not by Sight</a></h3>
							<p class="mb-5">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
				...
				<div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
					<div class="sermon-entry">
						<a href="sermon-single.html"><img src="images/sq-6.jpg" alt="Image" class="img-fluid mb-3 rounded"></a>
						<div class="sermon-body">
							<span class="date">10 Dec 2020 <span class="mx-2">&bullet;</span> By James Smith </span>
							<h3 class="mb-2"><a href="#">Live by faith not by Sight</a></h3>
							<p class="mb-5">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
